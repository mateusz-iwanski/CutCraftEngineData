...
namespace CutCraftEngineData.Configuration
{
    ...
    public class Advanced : DataGroupInput
    {
        ...
        /// </summary>
        public DynamicMethodSwitch dynamicMethodSwitch { get; set; } 
        ...
        /// </summary>
        public FastMethodForLastStockItems fastMethodForLastStockItems { get; set; } 
        ...
        /// </summary>
        public SearchPrecision searchPrecision { get; set; } 
